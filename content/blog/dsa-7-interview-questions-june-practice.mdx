...
The application is in. The trial invitation hasn't arrived yet — most schools send those between late June and early July, with the actual interviews and selection exercises clustering in **July and the first half of August**. Outcomes follow by **28 August 2026** — that's MOE's deadline for schools to notify, so an outcome can land earlier.
