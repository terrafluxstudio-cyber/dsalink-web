...
For a deeper look at exactly what trials assess in each of these sports, see our talent guides for [track and field](/dsa-interview/talents/track-field), [tennis](/dsa-interview/talents/tennis), and [gymnastics](/dsa-interview/talents/gymnastics). To see which schools offer your child's sport this year, use the [DSA-Sec School Finder](/dsa-finder); if you're new to all of this, start with [What is DSA-Sec?](/what-is-dsa); and when the calls come, our [DSA interview prep](/dsa-interview) walks through what to expect.
