...
heroImage: "/blog/dsa-final-two-weeks-trial-checklist.webp"
...
Once trials are done, the next significant milestone is the school notification, which MOE requires each school to send by 28 August 2026 — earlier is possible. After that comes the October School Preference Exercise. The [DSA Results phase guide](/dsa-results) covers the four possible outcomes — Confirmed Offer, Waitlist, Counter-Offer, Unsuccessful — and what each one binds you to.
