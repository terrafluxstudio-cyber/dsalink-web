...
## [Cedar Girls' Secondary](/open-house-takeaways#school-cedar) — Three categories, with Social Innovation as the signature
...
## [School of Science and Technology](/open-house-takeaways#school-sst) — The school that doesn't take PSLE postings
...
## [Yusof Ishak Secondary](/open-house-takeaways#school-yiss) — STEM and Robotics in a mainstream O-Level school
...
The selection mix is varied by talent area: panel interviews, individual assessment tasks, performance trials, video submissions (for Modern Dance), and e-portfolio reviews. The format depends on what you are applying for, so check the school's official DSA page for specifics. Shortlists go out around mid-July. Selections run through August. Outcomes are released by 28 August 2026.
...
Cedar, SST, and YISS all release their DSA outcomes on or before 28 August 2026 — the date MOE sets as the deadline for every school. By that point, most families with multiple applications will know exactly where they stand — months before PSLE results and the final DSA allocation land together, tentatively on 24 or 25 November 2026. The 28 August window is the real first inflection point of the DSA journey, not the 2 June application deadline.
...
Once the application closes, the next thing that matters is interview and trial prep. Our [DSA Interview Prep guide](/dsa-interview) covers what to prepare, how to practise daily, how parents can help, and how to handle questions in the room — plus 33 real DSA interview questions with model answer angles.
