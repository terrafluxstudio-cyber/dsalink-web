...
Methodist Girls' School is one of Singapore's six independent schools, a Methodist girls' school founded in 1887. It is distinct among girls' schools for offering the IB Diploma — rather than A-Levels — through its six-year Integrated Programme, alongside a four-year O-Level track, and for its Music Elective Programme (MEP), an MOE-designated music pathway. For DSA-Sec families, the MEP and music are genuine draws, together with a broad sports tradition including artistic swimming, squash, tennis and netball. The best fit is an academically able girl with a clear musical talent, a sporting strength, or a performing-arts ability, who is ready to weigh an early IP-to-IB commitment against the O-Level route and values a Methodist heritage. Read [What is DSA-Sec?](/what-is-dsa) to weigh the tracks, and confirm talent areas in the [DSA-Sec School Finder](/dsa-finder).
