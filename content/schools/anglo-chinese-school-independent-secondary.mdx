...
## What makes ACS (Independent) distinctive

ACS (Independent) is one of Singapore's six independent schools and the only one that is co-educational at both secondary and JC levels. It runs both the Integrated Programme and the O-Level track within one institution on Dover Road, with a Methodist mission heritage, and is affiliated to ACS (Primary) and ACS (Junior) as feeder schools. For DSA-Sec families, the school carries a broad and strong tradition across performing arts — concert band, choir, Chinese and Western orchestras, guzheng and guitar ensembles — and distinctive sports including rugby, cricket, golf and bowling. The best fit is an academically able child with a clear talent — musical, artistic or sporting — who is ready to weigh an early IP commitment against the more open O-Level route, and who values a Methodist heritage. Read [What is DSA-Sec?](/what-is-dsa) to weigh the tracks, and confirm talent areas in the [DSA-Sec School Finder](/dsa-finder).
