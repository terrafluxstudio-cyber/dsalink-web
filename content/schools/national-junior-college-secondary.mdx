...
description: "Complete guide to National Junior College (NJC) for Singapore parents — programmes, CCAs, campus, and A-Level admission via JAE."
...
## What makes National Junior College distinctive

NJC is primarily a junior college, but for P6 families the relevant part is its Integrated Programme secondary section, through which selected students join from Secondary 1 and continue six years on campus to A-Levels without sitting the O-Levels. Established in 1969, NJC was Singapore's first junior college and carries a long leadership-and-service tradition in the Bukit Timah area. Because the entry point is IP, a DSA-Sec decision here is really a decision about a six-year academic commitment, so families should weigh pace and fit before prestige. The campus draws academically able students with strong co-curricular interests, and DSA talent is assessed within that high-achieving setting. A child who is intellectually driven and ready for an early, sustained academic trajectory suits NJC's IP route best. Read [What is DSA-Sec?](/what-is-dsa) to understand the IP commitment, and confirm current talent areas in the [DSA-Sec School Finder](/dsa-finder).
