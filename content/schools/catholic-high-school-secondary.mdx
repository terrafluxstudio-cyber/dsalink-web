...
## What makes Catholic High distinctive

Catholic High is a SAP boys' school in Bishan with an uncommon structural feature: it runs both the Integrated Programme and the O-Level track, so a SAP, bilingual-bicultural education comes with a real choice of academic route. As an autonomous school it has added programme flexibility, with fees below the independent-school level. For DSA-Sec families, its Chinese cultural arts are a clear strength — Chinese orchestra, Chinese drama, guzheng and choir sit at the centre of school life — alongside concert band, guitar ensemble and modern dance. The strongest fit is a boy with genuine Chinese-language or Chinese-arts talent who would value a bilingual, bicultural environment, and whose family wants to weigh the IP against the O-Level route. A DSA offer specifies which track a talent area leads to, so check that before applying. Confirm this year's talent areas in the [DSA-Sec School Finder](/dsa-finder).
