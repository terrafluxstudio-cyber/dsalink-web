...
## What makes Victoria School distinctive

Victoria School is an autonomous boys' school with a long heritage and an uncommon dual-track structure: it runs both the Integrated Programme — affiliated with Victoria Junior College over six years — and the O-Level track, so a DSA-Sec offer may place a boy on either pathway. Its culture, built around the VICTORS values, has a strong performing-arts and sports tradition. For DSA-Sec families, the draws include a notable drama and performing-arts strength, a Chinese orchestra and concert band, and a distinctive Indian music and dance (Silambam) offering rarely found elsewhere. The best fit is a boy with a performing-arts or sporting talent who is ready to weigh the IP commitment against the O-Level route. Sitting in the East region, a DSA offer places students into its IP or O-Level track. Read [What is DSA-Sec?](/what-is-dsa) to weigh the tracks, and confirm talent areas in the [DSA-Sec School Finder](/dsa-finder).
