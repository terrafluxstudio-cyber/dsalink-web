...
import { AlertCircle, ArrowLeft, Eye, ListChecks } from "lucide-react";
...
export function OpenHouseGuideFull() {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {t.fieldGuide_back_link}
      </Link>

      <div className="mb-10 border-b border-slate-200 pb-8">
        <p className="text-[10px] font-semibold tracking-[0.15em] text-slate-700 normal-case">
          {t.fieldGuide_kicker}
        </p>
        <h1
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {CARDS.map(({ icon: Icon, titleKey, bodyKey, tipKey }) => (
          ...
          >
            <div className="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100">
            ...
            <div className="mt-5 rounded-lg bg-slate-50 px-4 py-3">
              <span className="mb-1.5 inline-block text-[10px] font-bold tracking-wider text-slate-700 normal-case">
