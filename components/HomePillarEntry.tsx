...
const BODY: LocaleStr = {
  en: "9 chapters · 6 parent stories · every talent area · the 2026 timeline · interview prep · 12-question FAQ · all four languages.",
  zh: "9 章节 · 6 家长故事 · 每个才艺方向 · 2026 时间线 · 面试备战 · 12 个常见问题 · 4 语言全覆盖。",
  ms: "9 bab · 6 kisah ibu bapa · setiap bidang bakat · garis masa 2026 · persediaan temu duga · FAQ 12 soalan · empat bahasa.",
  ta: "9 அத்தியாயங்கள் · 6 பெற்றோர் கதைகள் · ஒவ்வொரு திறமைப் பகுதியும் · 2026 கால அட்டவணை · நேர்காணல் தயாரிப்பு · 12-கேள்வி FAQ · நான்கு மொழிகள்.",
};
...
const CHAPTERS: ReadonlyArray<LocaleStr> = [
  ...
  { en: "All talent areas", zh: "每个才艺方向", ms: "Setiap bidang bakat", ta: "ஒவ்வொரு திறமைப் பகுதி" },
