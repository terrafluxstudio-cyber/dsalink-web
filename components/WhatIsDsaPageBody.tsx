  ...
  },
  {
    ...
    paragraphs: {
      ...
      zh: [
        ...
        "MOE 负责门。它运营中央门户 dsa-sec.moe.gov.sg——每年 5 月开放一次。MOE 设定时间表（2026 年：5 月 6 日到 6 月 2 日下午 4:30 截止，新加坡时间）。它把每所学校的 DSA 名额上限定在 S1 总名额的 20%，唯一例外是 4 所全 DSA 学校。它执行规则——每位申请人最多 3 所学校、每所学校最多 2 个才艺方向、同一时间只能持有 1 个 Confirmed Offer、接受后不可撤回。MOE 在 11 月底连同 PSLE 成绩一起公布 DSA 结果。",
      ...
      ms: [
        ...
        "MOE memiliki pintu. Ia mengendalikan portal pusat DSA-Sec di dsa-sec.moe.gov.sg — permohonan dibuka setahun sekali, pada bulan Mei. MOE menetapkan kalendar permohonan (untuk 2026: 6 Mei hingga 2 Jun, permohonan ditutup 4:30 petang waktu Singapura). Ia menghadkan pengambilan DSA pada 20% tempat S1 setiap sekolah, dengan empat sekolah DSA penuh sebagai satu-satunya pengecualian. Ia menguatkuasakan peraturan — maksimum tiga sekolah setiap pemohon, maksimum dua bidang bakat setiap sekolah, satu Tawaran Sah pada satu masa, tiada penarikan selepas penerimaan. Dan ia mengeluarkan keputusan DSA bersama keputusan PSLE pada akhir November.",
