...
export const Q_BANK: QBankCategory[] = [
  ...
  // ─── CATEGORY 3: Why This School ─────────────────────────────────────────
  {
    ...
    questions: [
      ...
      {
        id: "q-other-schools",
        q: "What other schools have you applied to through DSA, and why those?",
        subtext: {
          en: "This sounds like a friendly question. It usually isn't only that. Especially at IP schools and at schools whose CCA results lean heavily on the DSA students they bring in, the panel is reading two things at once. First, whether your other choices are coherent with the reason you just gave for wanting this school — if your stated 'fit' here doesn't match the kind of school your other applications are aimed at, the answer reads as either unconvincing or as this being a back-up. Second, which other schools are in the picture, which gives them a sense of how realistic it is that you'd actually take their offer if extended. DSA places are a finite resource — the cap is decided above the interviewing teachers, and the CCA receiving the students depends on them for the next four years of training and competition results. They're not just judging if you're talented; they're judging if choosing you is a safe call.",
          zh: "这听起来像随便聊聊，其实通常不只是这样。尤其是 IP 校，以及那些 CCA 成绩高度依赖 DSA 招进来的学生的学校，考官会同时在读两件事。第一，你的其他选择是否和你刚才说的\"为什么想来这所\"前后一致——如果你嘴上说的\"适合\"和你另外申请的那些学校气质对不上，这个答案听起来要么不可信，要么这所是你的备选。第二，还有哪些学校在跟他们抢你，这能让他们判断如果真的发了 offer，你接受的概率有多大。DSA 名额是有限的——上限由比面试老师更高层的人定下来，承接的 CCA 要靠这些学生支撑接下来四年的训练和比赛。他们不只在判断你有没有才能，也在判断挑你是不是一个稳妥的选择。",
          ms: "Soalan ini bunyinya santai. Biasanya bukan sekadar itu. Terutama di sekolah IP dan sekolah yang keputusan CCA-nya bergantung banyak pada pelajar DSA, panel membaca dua perkara serentak. Pertama, sama ada pilihan sekolah lain anda konsisten dengan alasan yang baru anda berikan untuk mahu sekolah ini — kalau 'kesesuaian' yang anda nyatakan tidak sepadan dengan jenis sekolah yang anda mohon di tempat lain, jawapan kedengaran tidak meyakinkan atau menunjukkan sekolah ini adalah pilihan kedua. Kedua, sekolah mana lagi yang terlibat, yang memberikan mereka gambaran sejauh mana anda akan benar-benar menerima tawaran jika diberi. Tempat DSA adalah sumber yang terhad — had ditentukan di peringkat yang lebih tinggi daripada guru penemuduga, dan CCA yang menerima pelajar bergantung kepada mereka untuk empat tahun latihan dan keputusan pertandingan. Mereka bukan sahaja menilai bakat anda; mereka menilai sama ada memilih anda adalah pilihan yang selamat.",
          ta: "இது ஒரு சாதாரண கேள்வியாக ஒலிக்கிறது. பெரும்பாலும் அது மட்டுமல்ல. குறிப்பாக IP பள்ளிகளிலும், CCA முடிவுகள் DSA மூலம் சேர்க்கப்படும் மாணவர்களை அதிகம் சார்ந்திருக்கும் பள்ளிகளிலும், குழு இரண்டை ஒரே நேரத்தில் வாசிக்கிறது. முதலாவது, உங்கள் மற்ற பள்ளி விருப்பங்கள் இந்த பள்ளியை விரும்புவதற்கு நீங்கள் இப்போது கூறிய காரணத்துடன் ஒத்திருக்கின்றனவா — நீங்கள் சொன்ன 'பொருத்தம்' மற்ற விண்ணப்பிக்கப்பட்ட பள்ளிகளின் தன்மையுடன் பொருந்தவில்லை என்றால், பதில் நம்பத்தகாததாக அல்லது இது உங்கள் இரண்டாம் தேர்வு என்று ஒலிக்கிறது. இரண்டாவது, வேறு எந்த பள்ளிகள் காட்சியில் உள்ளன என்பது, அவர்கள் சலுகை வழங்கினால் நீங்கள் உண்மையில் ஏற்பீர்களா என்பதை மதிப்பிட உதவுகிறது. DSA இடங்கள் வரம்புக்குட்பட்ட வளம் — வரம்பு நேர்காணல் ஆசிரியர்களை விட உயர்ந்த நிலையில் தீர்மானிக்கப்படுகிறது, மற்றும் மாணவர்களைப் பெறும் CCA அவர்களை அடுத்த நான்கு ஆண்டுகளின் பயிற்சி மற்றும் போட்டி முடிவுகளுக்காக சார்ந்துள்ளது. அவர்கள் உங்கள் திறனை மட்டும் மதிப்பிடவில்லை; உங்களை தேர்ந்தெடுப்பது பாதுகாப்பான முடிவா என்றும் மதிப்பிடுகின்றனர்.",
        },
        approach: {
          en: "Be honest. You can name your other one or two choices — pretending this is your only DSA application reads as evasive, and panels see through it. But how you frame those other choices matters more than the names themselves. Make them sound like a coherent set — schools with strong programmes in your talent area, or schools that share a learning culture you're drawn to — rather than a random scatter, which would suggest you don't actually know what you're looking for. Then re-anchor: explain what specifically makes this school the right fit, using a reason rooted in the programme itself (coaching pathway, peer culture, curriculum match), not 'because you're the one asking.' Never disparage another school you applied to — the interviewing teachers know each other professionally across the system, and that kind of remark travels.",
          zh: "诚实回答。可以说出你另外的1-2个选择——假装这是你唯一的 DSA 申请，听起来反而是在回避，考官一眼看穿。但比起说出哪几所学校，更重要的是你怎么描述这些选择。让它们听起来是一个连贯的组合——都是你才能领域强的学校，或者都有你认同的某种学习气质——而不是乱选一通，乱选会让考官觉得你其实不知道自己在找什么。然后回到本校：说清楚这所学校具体哪里合适，理由要扎根在项目本身（训练路径、同伴氛围、课程匹配），不能是\"因为是你在问所以是你\"。绝对不要贬低你申请的其他学校——面试老师之间在系统里是同行，这种话会传出去。",
          ms: "Jujur. Anda boleh sebutkan satu atau dua pilihan lain anda — berpura-pura ini permohonan DSA tunggal anda kedengaran mengelak, dan panel akan nampak. Tetapi cara anda membingkaikan pilihan-pilihan itu lebih penting daripada nama sekolahnya. Jadikan ia kedengaran sebagai set yang koheren — sekolah dengan program kuat dalam bidang bakat anda, atau sekolah yang berkongsi budaya pembelajaran yang menarik minat anda — bukan pilihan rawak, yang menunjukkan anda sebenarnya tidak tahu apa yang anda cari. Kemudian kembali ke sekolah ini: jelaskan apa yang khususnya menjadikan sekolah ini sesuai, dengan alasan yang berakar dalam program itu sendiri (laluan latihan, budaya rakan sebaya, padanan kurikulum), bukan 'kerana anda yang bertanya.' Jangan sekali-kali merendahkan sekolah lain yang anda mohon — guru-guru penemuduga saling mengenali secara profesional dalam sistem ini, dan perkataan seperti itu akan tersebar.",
          ta: "நேர்மையாக இருங்கள். உங்கள் மற்ற ஒன்று அல்லது இரண்டு விருப்பங்களை சொல்லலாம் — இது உங்கள் ஒரே DSA விண்ணப்பம் என்று பாசாங்கு செய்வது தவிர்ப்பதாக ஒலிக்கும், குழு உடனே புரிந்துகொள்ளும். ஆனால் அந்த மற்ற தேர்வுகளை எப்படி விவரிக்கிறீர்கள் என்பது பள்ளிகளின் பெயர்களை விட முக்கியம். அவை ஒரு ஒத்திசைவான தொகுப்பாக ஒலிக்க வேண்டும் — உங்கள் திறன் துறையில் வலுவான திட்டங்கள் கொண்ட பள்ளிகள், அல்லது நீங்கள் விரும்பும் கற்றல் கலாச்சாரத்தை பகிர்ந்துகொள்ளும் பள்ளிகள் — சீரற்ற தேர்வாக அல்ல, அது நீங்கள் என்ன தேடுகிறீர்கள் என்று உண்மையில் தெரியாது என்று காட்டும். பின் இந்த பள்ளிக்கு திரும்பவும்: இந்த பள்ளியை குறிப்பாக பொருத்தமாக்குவது என்ன என்று விளக்குங்கள், காரணம் திட்டத்திலேயே வேரூன்றியதாக இருக்க வேண்டும் (பயிற்சி பாதை, சக மாணவர் கலாச்சாரம், பாடத்திட்ட பொருத்தம்), 'நீங்கள் தான் கேட்கிறீர்கள் என்பதால்' அல்ல. நீங்கள் விண்ணப்பித்த வேறு பள்ளியை ஒருபோதும் இழிவாக பேசாதீர்கள் — நேர்காணல் ஆசிரியர்கள் முறையில் ஒருவரை ஒருவர் அறிவார்கள், அத்தகைய சொற்கள் பரவும்.",
        },
        templates: [
          {
            label: "Coherent set + re-anchor",
            text: "I've applied to [School A] and [School B] as well, alongside [This School]. The three of them aren't random choices — they're all schools with [common thread — e.g., serious [your talent area] programmes that compete at the national level / a learning culture that takes both academics and training seriously / strong coaching pipelines in [your discipline]]. What makes [This School] specifically the right fit for me is [one programme-rooted reason — e.g., the way your [CCA / programme] structures development from S1 onwards, which matches where I'm trying to go next / the coach I heard speak at the open house, whose philosophy on [specific thing] is exactly the environment I want to grow in]. The other schools are good schools. This one is the one I've thought about most carefully.",
          },
          {
            label: "Honest single-application answer (only if true)",
            text: "[This School] is the only school I applied to through DSA. I know that's unusual — most of my friends applied to two or three. I thought about it a lot with my parents and decided I'd rather be honest with myself: if I'm going to commit to a school for four years through DSA, I want it to be one I'm actually sure about, not three I'm hedging across. The reason it's this school is [one specific programme-rooted reason]. If it doesn't work out, I'll go through S1 posting and keep training [outside / through whichever school I'm posted to]. But I didn't want to apply somewhere just to have a back-up.",
          },
        ],
      },
      {
        id: "q-multi-offer",
        q: "If you receive offers from all three schools, how will you decide?",
        subtext: {
          en: "This is one of the most revealing questions in the interview, and at IP schools and competitive top schools it is asked deliberately, not casually. The panel is listening for whether you can give an honest, criteria-based answer without it sounding like you've already mentally ranked the schools and put this one second. Some panels even rephrase the question across the conversation — 'what if School A offers but we put you on a waitlist, who would you wait for?' — to see if your answer holds up when the scenario flips. The reason it matters this much: a school's DSA cap is a finite resource decided at the leadership level, and the CCAs that receive those students rely on them for the next four years of training and competition. An offer that doesn't convert into a student arriving in January is a real cost — to the CCA teacher who planned around it, and to the school's CCA results. They don't just want to know who is talented; they want to know who they can be confident will actually come. Different schools weigh this differently — a school where DSA is a small part of intake will care less than one where DSA fills 30%+ of S1 places — but it is rarely a neutral question.",
          zh: "这是面试中最能透露真相的问题之一。在 IP 校和竞争激烈的顶尖学校，这道题是被有意问出来的，不是闲聊。考官在听：你能不能给出诚实的、有标准的回答，又不让答案听起来像你心里已经排好了序、把这所学校放在了第二位。有些考官还会在对话里换个方式再问一次——\"如果A校发了 offer，但我们把你放在 waitlist，你会等谁？\"——看你的答案在情境翻转后是否依然站得住。背后的原因：每所学校的 DSA 名额是有限的，由学校管理层决定上限；承接这些学生的 CCA，要靠他们支撑接下来四年的训练和比赛。一个发出去但最终学生没到的 offer，对学校是实实在在的代价——对那位提前为他规划好的 CCA 老师，对学校的 CCA 成绩，都有影响。学校只想知道你有没有才能；更想知道，他们对\"你会真的来\"这件事能不能放心。每所学校的权重不一样——DSA 占新生比例小的学校在乎得少，DSA 占到 30%以上的学校在乎得多——但这道题很少是一道中性问题。",
          ms: "Ini salah satu soalan paling mendedahkan dalam temuduga. Di sekolah IP dan sekolah teratas yang berdaya saing, ia ditanya dengan sengaja, bukan secara santai. Panel mendengar sama ada anda boleh memberi jawapan yang jujur dan berasaskan kriteria tanpa kedengaran seperti anda sudah pun menyusun sekolah-sekolah itu dalam fikiran dan meletakkan sekolah ini di tempat kedua. Sesetengah panel akan menyusun semula soalan sepanjang perbualan — 'bagaimana jika Sekolah A menawarkan tetapi kami letak anda dalam senarai menunggu, siapa yang anda akan tunggu?' — untuk melihat sama ada jawapan anda kekal apabila senario diterbalikkan. Sebab ia penting: had DSA sesebuah sekolah adalah sumber terhad yang ditentukan di peringkat pimpinan, dan CCA yang menerima pelajar bergantung kepada mereka untuk empat tahun latihan dan pertandingan. Tawaran yang tidak bertukar menjadi pelajar yang tiba pada bulan Januari adalah kos sebenar — kepada guru CCA yang telah merancang sekitarnya, dan kepada keputusan CCA sekolah. Mereka bukan sahaja mahu tahu siapa yang berbakat; mereka mahu tahu siapa yang mereka boleh yakin akan benar-benar datang. Sekolah berbeza memberikan berat yang berbeza — sekolah di mana DSA adalah sebahagian kecil pengambilan akan kurang ambil peduli berbanding sekolah di mana DSA mengisi 30%+ tempat S1 — tetapi ia jarang menjadi soalan neutral.",
          ta: "இது நேர்காணலின் மிக வெளிப்படையான கேள்விகளில் ஒன்று. IP பள்ளிகளிலும், போட்டிமிக்க உச்ச பள்ளிகளிலும், இது வேண்டுமென்றே கேட்கப்படுகிறது, சாதாரணமாக அல்ல. நேர்மையான, அளவுகோல் அடிப்படையிலான பதிலை, பள்ளிகளை ஏற்கனவே மனதில் தரப்படுத்தி இந்த பள்ளியை இரண்டாமிடத்தில் வைத்திருப்பது போல் ஒலிக்காமல், சொல்ல முடியுமா என்று குழு கேட்கிறது. சில குழுக்கள் உரையாடல் முழுவதும் கேள்வியை மறுசீரமைப்பார்கள் — 'A பள்ளி வழங்கினால் ஆனால் நாங்கள் உங்களை காத்திருப்போர் பட்டியலில் வைத்தால், யாருக்காக காத்திருப்பீர்கள்?' — காட்சி மாறும்போது உங்கள் பதில் நிலைக்கிறதா என்று பார்க்க. இது இவ்வளவு முக்கியமாக இருப்பதற்கான காரணம்: ஒரு பள்ளியின் DSA வரம்பு தலைமை மட்டத்தில் தீர்மானிக்கப்படும் வரம்புக்குட்பட்ட வளம், மற்றும் அந்த மாணவர்களை பெறும் CCA-க்கள் அடுத்த நான்கு ஆண்டுகளின் பயிற்சி மற்றும் போட்டிக்காக அவர்களை சார்ந்துள்ளன. ஜனவரியில் வந்து சேராத மாணவராக மாறாத சலுகை ஒரு உண்மையான விலை — அதை சுற்றி திட்டமிட்ட CCA ஆசிரியருக்கும், பள்ளியின் CCA முடிவுகளுக்கும். அவர்கள் யார் திறமைசாலி என்று மட்டும் அறிய விரும்பவில்லை; யார் உண்மையில் வருவார்கள் என்று நம்பிக்கையுடன் இருக்க முடியும் என்று அறிய விரும்புகிறார்கள். வெவ்வேறு பள்ளிகள் இதற்கு வெவ்வேறு எடையை அளிக்கின்றன — DSA சேர்க்கையின் சிறிய பகுதியாக இருக்கும் பள்ளி, DSA 30%+ இடங்களை நிரப்பும் பள்ளியை விட குறைவாக கவலைப்படும் — ஆனால் இது அரிதாகவே நடுநிலையான கேள்வியாக இருக்கும்.",
        },
        approach: {
          en: "Don't say 'I'd pick the highest-ranked school' — that is exactly the answer that signals you aren't really committed to anyone. Don't say 'whatever my parents decide' — that says you don't own your own choice. The strongest answer names two or three specific criteria you would weigh (the coaching pathway in your talent area, how the school balances academics with training demand, the programme structure, the peer environment), and only then — if this school is genuinely your top choice — says so, calmly, and grounds it in one of those criteria. Confidence without arrogance. If this school is in your top consideration but you're still weighing, don't lie. Schools respect students who can talk about fit honestly more than ones who over-promise. Just be specific about what would tip your decision toward this school, so the panel sees the real reason — not a flattered version of it.",
          zh: "不要说\"我会选排名最高的\"——这正是会让人觉得你对谁都没真正承诺的答案。也不要说\"看父母怎么决定\"——这等于说你不为自己的选择负责。最有力的答案：说出你会权衡的两三条具体标准（你才能领域的训练路径、学校如何平衡学业和训练强度、项目结构、同伴环境），然后——如果这所学校确实是你的首选——平静地说出来，并用其中一条标准把理由落地。是有自信，不是傲慢。如果这所学校在你的认真考虑名单里但还在权衡，不要撒谎。学校尊重那些坦诚谈\"是否合适\"的学生，胜过那些过度承诺的学生。只要具体说明，什么样的条件会让你倾向选这所学校，让考官看到真正的理由——不是奉承版本的理由。",
          ms: "Jangan kata 'saya akan pilih sekolah peringkat tertinggi' — itu jawapan yang menandakan anda tidak benar-benar komited kepada sesiapa. Jangan kata 'apa sahaja ibu bapa saya putuskan' — itu bermakna anda tidak memiliki pilihan anda sendiri. Jawapan paling kuat menamakan dua atau tiga kriteria spesifik yang anda akan timbangkan (laluan latihan dalam bidang bakat anda, cara sekolah mengimbangi akademik dengan tuntutan latihan, struktur program, persekitaran rakan sebaya), dan barulah — jika sekolah ini benar-benar pilihan utama anda — katakan, dengan tenang, dan berakarkan satu daripada kriteria itu. Yakin tanpa angkuh. Jika sekolah ini dalam pertimbangan utama anda tetapi anda masih menimbang, jangan tipu. Sekolah menghormati pelajar yang boleh bercakap tentang kesesuaian dengan jujur lebih daripada mereka yang berjanji berlebihan. Hanya jadi spesifik tentang apa yang akan mengarahkan keputusan anda ke arah sekolah ini.",
          ta: "'நான் மிக உயர் தரம் கொண்ட பள்ளியை தேர்ந்தெடுப்பேன்' என்று சொல்லாதீர்கள் — அது நீங்கள் யாரிடமும் உண்மையில் அர்ப்பணிப்பு இல்லை என்று காட்டும் சரியான பதில். 'என் பெற்றோர் என்ன முடிவெடுத்தாலும்' என்றும் சொல்லாதீர்கள் — அது நீங்கள் உங்கள் சொந்த தேர்வுக்கு பொறுப்பு ஏற்கவில்லை என்று சொல்கிறது. மிக வலுவான பதில் நீங்கள் எடைபோடும் இரண்டு அல்லது மூன்று குறிப்பிட்ட அளவுகோல்களை பெயரிடுகிறது (உங்கள் திறன் துறையின் பயிற்சி பாதை, பள்ளி கல்வியை பயிற்சி கோரிக்கையுடன் எவ்வாறு சமநிலைப்படுத்துகிறது, திட்ட அமைப்பு, சக மாணவர் சூழல்), பின் — இந்த பள்ளி உண்மையாகவே உங்கள் முதல் விருப்பமாக இருந்தால் — அமைதியாக சொல்லி, அந்த அளவுகோல்களில் ஒன்றில் வேரூன்றுங்கள். தற்பெருமை இல்லாமல் நம்பிக்கை. இந்த பள்ளி உங்கள் முதல் பரிசீலனையில் உள்ளது ஆனால் நீங்கள் இன்னும் எடைபோட்டுக்கொண்டிருந்தால், பொய் சொல்லாதீர்கள். அதிகமாக வாக்குறுதி அளிப்பவர்களை விட, பொருத்தம் பற்றி நேர்மையாக பேச முடியும் மாணவர்களை பள்ளிகள் மதிக்கின்றன. இந்த பள்ளியை நோக்கி உங்கள் முடிவை சாய்க்கும் காரணிகள் என்ன என்பதில் குறிப்பாக இருங்கள்.",
        },
        templates: [
          {
            label: "This school is genuinely my first choice",
            text: "There are a few things I'd weigh. The first is the coaching pathway in [my talent area] — specifically, does the programme push students at my current level, or does it mostly cater to one end of the range? The second is how the school handles the balance between training load and academics, because I know S1 to S4 is going to be heavier than P6. The third is the peer environment — am I joining a group of students who'll push me, or one I'll be carrying. Honestly, when I weigh those, [This School] comes out top for me. The clearest reason is [one specific programme-rooted detail — e.g., the way your [CCA] structures progression from S1, which is exactly where I want to start building / a coach whose philosophy I heard at the open house and want to learn from]. If I get all three offers, I'll be choosing here.",
          },
          {
            label: "This school is in my top consideration — honest weighing",
            text: "I'd be lying if I said I had it all decided already — and I don't think a good decision works that way at this stage. What I can tell you is what I'd weigh. [Criterion 1 — e.g., which school's coaching pathway in [talent] matches the level I've reached]. [Criterion 2 — e.g., the culture around studies and training; I want a school that takes both seriously, not one that treats one as a tax on the other]. [Criterion 3 — e.g., whether I can see myself contributing from S1, not just receiving]. [This School] is firmly in my top consideration — what would make it the choice is [one specific thing — e.g., if today's conversation gives me a clearer picture of how [a specific aspect of the programme] actually works week-to-week]. I'm telling you honestly because I think that's more useful to both of us than a rehearsed 'you're my first choice.'",
          },
        ],
      },
      {
