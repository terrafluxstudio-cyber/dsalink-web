...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    subscribeMaterial4: "DSA application timeline & key-dates checklist",
  ...
  zh: {
    ...
    subscribeMaterial4: "DSA 申请时间轴与关键日期清单",
  ...
  ms: {
    ...
    subscribeMaterial4: "Senarai semak garis masa permohonan DSA & tarikh penting",
  ...
  ta: {
    ...
    subscribeMaterial4: "DSA விண்ணப்ப கால அட்டவணை & முக்கிய தேதிகள் சரிபார்ப்பு பட்டியல்",
